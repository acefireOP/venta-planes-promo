      ...
      <Wrapper>
        ...
        {formData.successFlow === false && (
          <>
            ...
            {formData.selectedPlan === '400gb-50dcto' && <TitleSection>¡Nadie te da más!</TitleSection>}
            {formData.selectedPlan === '500gb-50dcto' && <TitleSection>¡Nadie te da más!</TitleSection>}
            ...
            {formData.selectedPlan === '400gb-50dcto' && <SubTitleSection>Porta un plan adicional con <span>50% dcto por 1 año</span></SubTitleSection>}
            {formData.selectedPlan === '500gb-50dcto' && <SubTitleSection>Porta un plan adicional con <span>50% dcto por 1 año</span></SubTitleSection>}
            ...
            {formData.selectedPlan === '400gb-50dcto' && <BajadaInfo>Si quieres que te llamemos para contratar este u otro plan <span onClick={() => setOpenModalC2c(!openModalC2c)}>haz click aquí</span></BajadaInfo>}
            {formData.selectedPlan === '500gb-50dcto' && <BajadaInfo>Si quieres que te llamemos para contratar este u otro plan <span onClick={() => setOpenModalC2c(!openModalC2c)}>haz click aquí</span></BajadaInfo>}
