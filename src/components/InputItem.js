...
const InputItem = ({
  ...
  const blurValidation = () => {
    ...
    /*if (nameInput === "dispatchAddressStreet") {
      if (!onlyLetters(formData[nameInput])) {
        invalidSetter("dispatchAddressStreet", false, true);
      } else {
        invalidSetter("dispatchAddressStreet", true, false);
        setErrorMessage("No ocupes números");
      }
      formData[nameInput] === "" && invalidSetter("dispatchAddressStreet", false, false);
    }*/
    if (nameInput === "ci") {
  ...
  return (
    <InputContainer className={classAdd}>
      ...
      <TextInput
        hasicon={iconInput}
        name={nameInput}
        onKeyPress={(nameInput === "phone" ? onlyNumbers : null) || (nameInput === "phoneToMigrate" ? onlyNumbers : null) || (nameInput === "dispatchAddress" ? onlyNumbers : null) || (nameInput === "contractAddress" ? onlyNumbers : null)}
