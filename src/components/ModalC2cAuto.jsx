...
const ModalC2cAuto = ({isOpenC2c, setIsOpenC2c}) => {
    ...
    >
      <div className="modal-dialog">
        <div className="modal-body">
          <IframeC2c src={`https://www.wom.cl/_formularios/_formulario-c2c-linea-adicional/?plan=${formData.selectedPlan}&o=automodal`}></IframeC2c>
        </div>
      </div>
